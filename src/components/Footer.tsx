...
import { navigationLinks, websiteConfig } from "@/lib/data";
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4 mt-6">
              <a 
                ...
                className="h-10 w-10 rounded-full bg-background flex items-center justify-center border border-border hover:bg-primary/10 transition-colors"
                aria-label="GitHub"
              >
                <svg 
